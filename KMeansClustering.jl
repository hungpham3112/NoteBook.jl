...
# ╔═╡ e820fbee-38e7-11ed-27b3-15abad40a0bc
begin
	using Statistics
	using Plots
end

# ╔═╡ 4462b289-05da-413b-b495-456d27cbde1b
md"""
## Create a dataset
"""

# ╔═╡ 54269d24-824b-4abf-8afd-d6a7bbae1df3
md"""
### Form a circle
"""

# ╔═╡ 36ff2cf0-659d-4e34-8c39-8553d0cf97d5
function circle_shape(h, k, r)
	θ = LinRange(0, 2π, 500)
	return h .+ r * sin(θ), k .+ r * cos.(θ)
end

# ╔═╡ d3c815fe-c59b-455a-8aef-6831038f6ee4
cluster1 = [4]

# ╔═╡ 597fb7c1-4622-476d-92a2-66844122836a


# ╔═╡ 8b510d17-e4ec-4830-bbaf-c890dab6313c
