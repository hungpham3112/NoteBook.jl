...
# ╔═╡ 3507e890-4160-11ed-1695-2fca1aded0d4
begin
	using Flux
	using Random
	using Plots
...
# ╔═╡ f85a6c34-0df9-44e1-94b7-649aca7320cb
md"""
## Create a Sigmoid Function
"""

# ╔═╡ a4565ca7-7eb1-44bb-a41c-9efb938dee6f
begin
	input = rand(10)
...
# ╔═╡ 0b826c7b-15fd-4338-ac1f-b29c40051016
begin
	x = 1:10; y = rand(10); # These are the plotting data
	plot( y)
end

# ╔═╡ 1d26961c-d290-49a1-a83f-72a670db6c44
rand(10)

# ╔═╡ c5bce46c-2acf-4a46-8eaf-d225e76ebbb9
md"""
## Create a Dense
"""

# ╔═╡ ee2d9dff-d97d-4857-9c59-db1c0d48d102
dense = Dense(2, 1, σ)

# ╔═╡ 4d7f94bc-3460-4abc-bf4b-296df6c63d19
dense.weight

# ╔═╡ 9834915d-4787-4524-b53e-1c6495df815d
typeof(dense.weight)

# ╔═╡ c7cd080d-9e53-49e6-818d-3affd79ca2a4
dense.bias

# ╔═╡ 83c3e421-8c19-4660-8644-1ab9a601bbb9
layer1 = Dense(1, 1)

# ╔═╡ 18cd963a-682e-40ba-9d50-94801b65a004
layer2 = Dense(1, 1)

# ╔═╡ cba170e8-2943-4b36-b243-db3260b88813
model = Chain(layer1, layer2)

# ╔═╡ 54078caf-f100-4767-a78b-cf745cac7ac6
md"""
## Create convolution layer
"""

# ╔═╡ 3ef1d498-13f5-407a-bc45-17519720501a
layer = Conv((5, 5), 3 => 7, relu)

# ╔═╡ 48353442-b9b9-4aaf-a8ca-f7d1acc461b0
xs = rand(Float32, 100, 100, 3, 50)

# ╔═╡ 6bf7ed19-0658-4f79-8e59-48114904e789
xs[1]

# ╔═╡ e2548712-c3a7-47a3-b3ac-b955bb78c51c
layer(xs)

# ╔═╡ 8da0c3d7-cd2f-4542-a17a-81bca9dc9fc8
layer.weight

# ╔═╡ 07aea689-6624-4759-9e1a-5fbc29452175


# ╔═╡ 4f8cd395-a541-4453-ae05-ea36e22dfd58


# ╔═╡ b85ba8d0-dc6c-4020-b423-e5f83bd3d1c1


# ╔═╡ 7ef34b11-c64b-455a-af1d-74f406922a7c


# ╔═╡ 9b02c456-3286-408e-86df-0ee9deabf4a9


# ╔═╡ 2438788e-ded9-44cd-ba9a-fba27b3de9c1


# ╔═╡ 2e04fa45-bcc1-4ce6-b9a7-4bad09db7465


# ╔═╡ bdf1b493-85f3-4935-b045-4432e178a4ca
...
julia_version = "1.8.1"
manifest_format = "2.0"
project_hash = "142065254898886a9909d667b67a8b7ac0d446c6"
