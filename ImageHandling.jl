...
# ╔═╡ 7c0e36c3-1dfc-41a2-a5ca-82245518d73e
begin
	using Images, ImageView
	using PlutoUI
end

# ╔═╡ 650b690c-d59e-4360-8a28-3733e31b099f
md"""
# Loading image from path
"""

# ╔═╡ c4353157-1486-4870-bc15-130fcb1a3451
image_path = raw"./julia_logo.png"

# ╔═╡ fb307e89-08bd-40c5-a23a-05f74a896215
typeof(image_path)

# ╔═╡ d8df99c9-39d0-4c50-9906-91296e2ebcb8
source_image = load(image_path)

# ╔═╡ 801b6893-5888-4b25-8c83-e6d656ef70db
size(source_image)

# ╔═╡ 2320aa4e-2bb5-4431-a11d-3a1b2eb2171a
md"""
### Scaling by percentage
"""

# ╔═╡ c7986bd7-16be-4bc1-ab24-62a32b0d0cd7
@bind scale_percentage Slider(0.1:0.1:1)

# ╔═╡ 091c0452-d1c4-49b3-ba28-c1882bc7385d
new_size = trunc.(Int, size(source_image) .* scale_percentage)

# ╔═╡ 1f91e785-b992-4992-8072-fc48a8359407
resized_image = imresize(source_image, new_size)

# ╔═╡ 9a268349-f6c0-4409-868d-0c66ae7b2d13
md"""
### Scaling by two-fold
"""

# ╔═╡ 355702db-53b8-44d1-9f3e-0f5116dc4f84
restricted_image_height = restrict(source_image, 1)

# ╔═╡ 79400902-0eb3-4d21-bdbc-d8f99b9794e9
restrictec_image_width = restrict(source_image, 2)
...
julia_version = "1.8.2"
manifest_format = "2.0"
project_hash = "d9fb380aaaf6a18d857e90e40f197f672c179044"
